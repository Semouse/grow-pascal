...
2.14 Напишите программу, выдающую состоящую из звёздочек букву Z с горизонтальной поперечиной, имеющую заданную(введённую пользователем) высоту (и такую же ширину).
Если пользователь пытается ввести чётное число или число мень-ше пяти, выдавайте сообщение об ошибке и просите пользователя повторить ввод.
решение: zet.pas
